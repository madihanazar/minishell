...
//parse_4.c
bool		split_redirects(char *str, char *beg, t_tree **l, t_tree **r);
...
//preprocess.c
bool		preprocess(t_shell *s, t_context *con, t_tree *node, char **env);
bool		proc_hdocs(t_shell *s, t_context *con, t_tree *node, char **env);
bool		proc_pipes(t_shell *s, t_context *con, t_tree *node, char **env);
...
bool		process_output(t_context *con, t_tree *node, char **env, int flag);
